...
(cl:defmethod pid_vel-val ((m <pid_input>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rc_car-msg:pid_vel-val is deprecated.  Use rc_car-msg:pid_vel instead.")
  (pid_vel m))

(cl:ensure-generic-function 'pid_error-val :lambda-list '(m))
(cl:defmethod pid_error-val ((m <pid_input>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rc_car-msg:pid_error-val is deprecated.  Use rc_car-msg:pid_error instead.")
  (pid_error m))
