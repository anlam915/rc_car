...
(cl:defmethod cl:initialize-instance :after ((m <drive_param>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'drive_param)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rc_car-msg:<drive_param> is deprecated: use rc_car-msg:drive_param instead.")))

(cl:ensure-generic-function 'velocity-val :lambda-list '(m))
(cl:defmethod velocity-val ((m <drive_param>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rc_car-msg:velocity-val is deprecated.  Use rc_car-msg:velocity instead.")
  (velocity m))
